...
import { Image, StyleSheet, SafeAreaView, FlatList, Dimensions, Share, ActivityIndicator } from 'react-native';
...
import Carouselimage_Home from '../common/carousel';
  ...
  render() {
    ...
    return (
      <View >
        ...
        <Text style={Styles.notificationtop} note numberOfLines={2}>Howdy {this.user} </Text>
