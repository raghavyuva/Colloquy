    ...
    firebase
      ...
      .onSnapshot((querySnapshot) => {
        const threads = querySnapshot.docs.map((documentSnapshot) => {
          if (
            documentSnapshot.data().UserType.sentBy === user.user._id ||
            documentSnapshot.data().UserType.sentTo === user.user._id
          ) {
            // console.log('hey')
      ...
      <FlatList
        ...
        renderItem={({ item, index }) => (
          <>
            ...
            item.UserType.sentTo === user.user.user._id ? (
              <>
                {item.UserType.sentBy === user.user.user._id ? (
                  <TouchableOpacity
                    onPress={() => {
                      MessageParticularguy(item.latestMessage.user2);
                    }}
                  >
                    <View
                      style={{
                    ...
                    >
                      ...
                      >
                        ...
                        <Left>
                          <Body>
                            <Text
                              style={styles(colors).listTitle}
                              numberOfLines={1}
                            >
                              {item.latestMessage.user2.username}
                            </Text>
                            <Text
                              note
                        ...
                        <Right>
                          <Body style={{ justifyContent: "flex-end" }}>
                            ...
                            <Text note style={{ color: colors.primary }}>
                              {new Date(item.latestMessage.createdAt)
                                .toTimeString()
                                .split("GMT+0530 (IST)")}
                            </Text>
                  ...
                  <TouchableOpacity
                    onPress={() => {
                      MessageParticularguy(item.UserType.SentUserDetails);
                    }}
                  >
                    <View
                      style={{
                        ...
                        <Left>
                          <Body>
                            <Text
                              ...
                              numberOfLines={1}
                            >
                              {item.UserType.SentUserDetails.username}
                            </Text>
                            <Text
                              note
                              style={styles(colors).listDescription}
  ...
  const FabComponent = () => {
    return (
      ...
      >
        ...
        <Button
          style={{ backgroundColor: "green", marginBottom: 40 }}
          onPress={() => {
        ...
        <Button
          style={{ backgroundColor: "#DD5", marginBottom: 40 }}
          onPress={() => Linking.openURL("https://raghav.orak.in/releases")}
        >
        ...
        <>
          ...
          >
            ...
            <Item style={{ backgroundColor: colors.background }}>
              ...
              <Input
                placeholder="Find People to text"
                style={{
