    ...
    return (
        <View style={{}}>
                ...
                <Image source={require('../assets/logoorange.png')} style={{ width: 100, height: 200 ,alignSelf:'center'}} />
                    <Button style={{ backgroundColor: colors.card, borderColor: 'grey', borderWidth: 1, alignSelf: 'center',width:200,justifyContent:'center' }} onPress={onloginpress}>
                        <Text style={{ color: colors.text, textTransform: 'capitalize', textAlign: 'center' }}>Login</Text>
                    </Button>
                    <Button style={{ backgroundColor: colors.card, borderColor: 'grey', borderWidth: 1, alignSelf: 'center',width:200,justifyContent:'center' }} onPress={onsignuppress}>
